...
<html>
    ...
    <body>
        ...
        $nombre = ''; //SE DECLARAN AQUI PARA EVITAR ALGUNOS WARNINGS, NO SERIA NECESARIO, PERO ES BUENA COSTUMBRE Q SE DECLAREN EN LA CABECERA
        $edad = '';
        $email = '';
        $errores_array = array();//PODRIA SER [] 

        if (isset($_GET['submit'])) {
            //MANERA CONCISA DE FILTRAR EL CONTENIDO POR LA SUPERGLOBAL GET
            //FILTER INPUT ES UNA FORMA MODERNAA DE VALIDAR, PERO APRENDEREMOS CON FRAMEWORK
            //FILTER CALLBACK-> LLAMA A LA FUNCION VALIDAR NOMBRE
            //SE PODRIA HABER METIDO SOLO UNA FUNCION QUE CONTUVIERA VALIDACION DE LOS DATOS ENTEROS
...
// email se valida pero no es obligatorio.
            if ($email === FALSE && is_null($email)) {//PODRIA SER OR EN VEZ DE AND?
